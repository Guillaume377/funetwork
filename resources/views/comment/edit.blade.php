    ...
    <main class="container">
        <div class="row d-flex justify-content-center text-center">
            ...
            <div class="container titre">
                <h1 class="py-3 m-5">Mon commentaire</h1>
            </div>

            <div class="container titre">
                <h3 class="py-3 m-5">Modifier mon commentaire </h3>
            </div>

            <div class="row modifpost">

                <form class="col-4 mx-auto" action="{{ route('comment.update', $comment) }}" enctype="multipart/form-data"
